...
void getWGS84Pos(double *latitude, double *longitude);
...
main(){
	double WGS84lat = -34.87997222;
	double WGS84long = -56.16394444;
	double yacEasting = 0.0;
	double yacNorthing = 0.0;

	//getWGS84Pos(&WGS84lat, &WGS84long);
	printf("En WGS84: La latitud en grados es %f y la longitud en grados es %f\n", WGS84lat, WGS84long);
	double WGS84latRad = toRad(WGS84lat);
	double WGS84longRad = toRad(WGS84long);
